...
class Snake(pg.sprite.Sprite):
    ...
    def has_colise(self, apple, dx, dy):
        ...
        if head_rect.collideobjects([apple]):
            apple.color = choice(['yellow', 'orange', 'magenta'])
...
class Apple(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.colors = ['yellow', 'orange', 'magenta']
...
while 1:
    ...
    text2 = font.render(f'Привет {is_user[0][0]}! Твой лучший рекорд {is_user[0][1]}', 1, 'white', pg.color.Color(65, 250, 99))
