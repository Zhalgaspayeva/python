...
# class Apple1(pygame.sprite.Sprite):
#     def __init__(self):
#         super().__init__()
#         self.Food_position_generate()
#     def Food_position_generate(self):
#         global Food_position1

#         Position = [random.randint(0, 40)*Pixel,random.randint(0, 40)*Pixel]
#         for pos in Snake_body:
#             if Position[0] == pos[0] and Position[1] == pos[1]:
#                 self.Food_position_generate()
#         Food_position1 = Position
...
while True:
    ...
    #pygame.draw.rect(screen, RED, pygame.Rect(Food_position1[1], Food_position1[0], Pixel, Pixel))
